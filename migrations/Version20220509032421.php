 ...
 */
final class Version20220509032421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication ADD user_id INT NOT NULL, ADD tel VARCHAR(255) NOT NULL, CHANGE date date DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication DROP user_id, DROP tel, CHANGE date date DATE DEFAULT NULL');
        $this->addSql('CREATE INDEX userId_fk ON publication (userIdd)');
