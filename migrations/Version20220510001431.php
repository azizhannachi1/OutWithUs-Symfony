 ...
 */
final class Version20220510001431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` CHANGE evenement_id evenement_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `like` CHANGE evenement_id evenement_id INT NOT NULL');
