 ...
 */
final class Version20220509035638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication ADD user_id INT NOT NULL, CHANGE date date DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE publication DROP user_id, CHANGE date date DATE DEFAULT NULL');
