 ...
 */
final class Version20220503003803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE usersn_categoriesn (usersn_id INT NOT NULL, categoriesn_id INT NOT NULL, INDEX IDX_EC4D19A61D0DCDC2 (usersn_id), INDEX IDX_EC4D19A610A5065C (categoriesn_id), PRIMARY KEY(usersn_id, categoriesn_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE usersn_categoriesn ADD CONSTRAINT FK_EC4D19A61D0DCDC2 FOREIGN KEY (usersn_id) REFERENCES usersn (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE usersn_categoriesn ADD CONSTRAINT FK_EC4D19A610A5065C FOREIGN KEY (categoriesn_id) REFERENCES categoriesn (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categoriesn_usersn (categoriesn_id INT NOT NULL, usersn_id INT NOT NULL, INDEX IDX_39941F6B10A5065C (categoriesn_id), INDEX IDX_39941F6B1D0DCDC2 (usersn_id), PRIMARY KEY(categoriesn_id, usersn_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('DROP TABLE usersn_categoriesn');
