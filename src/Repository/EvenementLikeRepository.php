...
/**
 * @extends ServiceEntityRepository<EvenementLike>
 *
...
class EvenementLikeRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(EvenementLike $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(EvenementLike $entity, bool $flush = true): void
    {
